...
//            System.out.println(arr[5]);     // 인덱스 범위를 초과 #예외2
//        } catch (NumberFormatException e ){
...
//        System.out.println("=======================================");
//
//        // TITLE : 어떤 예외가 발생하는지 확인 하는 방법 (추가)
//        int[] arr = {1, 2, 3 , 4};
//        try {
//            System.out.println(arr[4]);
//        } catch (ArrayIndexOutOfBoundsException e){ // exception e 로 어떤 종류의 예외든 다 캐치하고 e.printStackTrace()로 확인 하고 수정
//            e.printStackTrace(); // 어떤 예외가 발생 했는지 확인. (오류 코드로 보여줌)
...
//
//        try{
//            System.out.println(arr[3]);//arr[] 인덱스가 3이든 4든 finally 문의 실행문은 무조건 실행됨
//        } catch (ArrayIndexOutOfBoundsException e ){
//            System.out.println("배열으 크기를 초과했습니다.");
//        } finally {
//            System.out.println("배열의 크기를 초과 했더라도 실행해라 아니어도 실행해라");
//        }
