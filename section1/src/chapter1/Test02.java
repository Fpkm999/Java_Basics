...
public class Test02 {
	...
	public static void main(String[] args) {
		...
		// 1, I, l, | , O 0 <-- 기본 돋움폰트같은 경우 구분이 안되는데 요즘 IDE 에선 코딩용 폰트(D2Coding)등을 지원해서 지금은 따로 세팅할 필요는 없다.
		
		float f = 1.2345678901234567890f;
		float f3 = 1.2f; // 접미사 없어서 에러
		// 소수형태는 기본이 double이므로 float을 쓸때는 값뒤에 f를 붙여줘야함.
